...
plot_2 <- final_house %>% select(Date_time, Global_active_power) 

png(filename = "plot2.png")
plot(plot_2$Date_time, plot_2$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
dev.off()
